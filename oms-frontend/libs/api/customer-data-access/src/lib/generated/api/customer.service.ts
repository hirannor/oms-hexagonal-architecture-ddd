...
export class CustomerApi extends BaseService {
  ...
  public authenticatedCustomer(
    ...
    return this.httpClient.request<CustomerModel>(
      'get',
  ...
  public changePersonalDetails(
    customerId: string,
    changePersonalDetailsModel?: ChangePersonalDetailsModel,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json';
  ...
  public changePersonalDetails(
    ...
    if (customerId === null || customerId === undefined) {
      throw new Error(
        'Required parameter customerId was null or undefined when calling changePersonalDetails.'
      );
    }
  ...
  public deleteBy(
    ...
    if (customerId === null || customerId === undefined) {
      throw new Error(
        'Required parameter customerId was null or undefined when calling deleteBy.'
      );
    }
  ...
  public displayAll(
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Array<CustomerModel>>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
