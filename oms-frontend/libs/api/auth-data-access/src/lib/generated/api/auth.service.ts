...
export class AuthApi extends BaseService {
  ...
  public authenticate(
    ...
    if (authenticateModel === null || authenticateModel === undefined) {
      throw new Error(
        'Required parameter authenticateModel was null or undefined when calling authenticate.'
      );
    }
    ...
    return this.httpClient.request<AuthenticationResultModel>(
      'post',
  ...
  public refreshToken(
    ...
    if (refreshRequestModel === null || refreshRequestModel === undefined) {
      throw new Error(
        'Required parameter refreshRequestModel was null or undefined when calling refreshToken.'
      );
    }
  ...
  public register(
    ...
    if (registerModel === null || registerModel === undefined) {
      throw new Error(
        'Required parameter registerModel was null or undefined when calling register.'
      );
    }
